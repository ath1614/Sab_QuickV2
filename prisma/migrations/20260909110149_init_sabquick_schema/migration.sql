-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'RIDER', 'PACKER', 'MANAGER', 'OWNER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PACKING', 'READY_FOR_PICKUP', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('UPI_DOORSTEP', 'CASH_ON_DELIVERY', 'ONLINE_PREPAID');
...
CREATE TABLE "Order" (
    ...
    "deliveryOtp" TEXT NOT NULL DEFAULT '1234',
    "subtotal" DOUBLE PRECISION NOT NULL,
    "deliveryFee" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "handlingFee" DOUBLE PRECISION NOT NULL DEFAULT 2,
    "tipAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalAmount" DOUBLE PRECISION NOT NULL,
    "paymentMethod" "PaymentMethod" NOT NULL DEFAULT 'UPI_DOORSTEP',
...
CREATE TABLE "ThemeConfig" (
    "id" TEXT NOT NULL DEFAULT 'active_theme',
    "themeName" TEXT NOT NULL DEFAULT 'Standard',
...
-- CreateIndex
CREATE INDEX "Category_displayRank_idx" ON "Category"("displayRank");
