...
async function main() {
  console.log("\u{1F331} Starting SabQuick database seeding...");
  console.log("\u{1F9F9} Purging existing records...");
  ...
  console.log("\u{1F3A8} Seeding ThemeConfig...");
  ...
  const manager = await prisma.user.create({
    data: {
      ...
      phone: "9876500002",
      phoneVerified: true,
      role: import_client.Role.MANAGER
    }
  });
  const packer = await prisma.user.create({
    data: {
      ...
      phone: "9876500003",
      phoneVerified: true,
      role: import_client.Role.PACKER
    }
  });
  ...
  const customer = await prisma.user.create({
    data: {
      ...
      phone: "9876543210",
      phoneVerified: true,
      role: import_client.Role.CUSTOMER,
      addresses: {
        create: {
          label: "Home",
  ...
  console.log("\u{1F4C2} Seeding Two-Tier Categories...");
  ...
  console.log("\u{1F6D2} Seeding Products...");
  const productsData = [
    // Milk
    {
  ...
  console.log("\u{1F680} SabQuick database seeding completed successfully!");
}
main().catch((e) => {
