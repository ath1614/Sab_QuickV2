...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  // Seasons
  { key: "summer", name: "Summer Chill", primaryColor: "#0E7490", accentColor: "#22D3EE", saleTagText: "☀️ Summer Chill — Cold Drinks & Ice Creams" },
  { key: "monsoon", name: "Monsoon Mood", primaryColor: "#1E40AF", accentColor: "#60A5FA", saleTagText: "🌧️ Monsoon Mood — Hot Snacks & Pakoras" },
  { key: "winter", name: "Winter Warmth", primaryColor: "#3730A3", accentColor: "#818CF8", saleTagText: "❄️ Winter Warmth — Cozy Comfort Foods" },
