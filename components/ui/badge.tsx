  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none",
  {
    variants: {
      variant: {
        ...
        accent:
          "border-transparent bg-primary-accent text-surface-dark shadow hover:bg-primary-accent/80 font-bold",
        secondary:
          "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",
        destructive:
          "border-transparent bg-destructive text-destructive-foreground shadow hover:bg-destructive/80",
        outline: "text-foreground border-border-subtle",
        dark: "border-transparent bg-surface-dark text-surface-light",
      },
    },
    defaultVariants: {
      variant: "default",
