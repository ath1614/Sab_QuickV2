...
export default function OwnerError({
  ...
  React.useEffect(() => {
    console.error("[Owner Portal Error Boundary Caught]:", error);
  }, [error]);
      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm text-center space-y-5">
        ...
        <div className="space-y-1.5">
          <h2 className="text-lg font-black text-slate-900 tracking-tight">
            Owner Portal Encountered an Issue
          </h2>
          <p className="text-xs text-slate-500 max-w-xs mx-auto leading-relaxed">
            A temporary client exception occurred while updating operations.
          </p>
        </div>
